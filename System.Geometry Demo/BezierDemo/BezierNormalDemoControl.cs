...
{
    public class BezierNormalDemoControl : BezierDemoControl
    {
        public BezierNormalDemoControl() : base()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (double t = 0; t <= 1; t += 0.1)
            {
                ...
                Vector2 nv = Bezier.Normal(t);
                DrawLine(e.Graphics, pt, pt + nv * 40, Color.Red, 1);
            }
